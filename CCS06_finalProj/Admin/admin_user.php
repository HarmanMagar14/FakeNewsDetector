    ...
    <div class="row">
      <nav class="col-md-2 d-none d-md-block sidebar p-3">
        <h4 class="text-white mb-4 d-flex align-items-center">
          <img src="loginBackground.png" alt="Logo" width="250" class="me-2">
        </h4>
        <ul class="nav flex-column">
          ...
          <li class="nav-item"><a class="nav-link active" href="admin_user.php"><i class="bi bi-people me-2"></i>Users</a></li>
